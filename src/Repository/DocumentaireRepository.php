...
/**
 * @extends ServiceEntityRepository<Documentaire>
 *
...
class DocumentaireRepository extends ServiceEntityRepository
{
    ...
    public function save(Documentaire $entity, bool $flush = false): void
    {
    ...
    public function remove(Documentaire $entity, bool $flush = false): void
    {
